...
- ⚠️ Gefährliche Stellen (z.B. schnelle Autos, parkende Autos auf Gehwegen, fehlende Überwege)
- 👍 Gute Stellen (z.B. Zebrastreifen, Ampeln, Schülerlotsen)

Die App speichert automatisch den GPS-Standort. Am Ende zeigen die Kinder einen QR-Code, der vom Lehrer gescannt wird. Alle Daten können dann als GeoJSON oder CSV exportiert werden.
...
*Entwickelt für die Jugendpflege Kirkel*
